...
class SocietyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let maps = MapInfosViewModel.shared.getMapsFake(withClock: false, canSetFavorite: false)
        ...
        self.contentStackView.insertArrangedSubview(self.mapInfoListCollectionView, at: 1)
